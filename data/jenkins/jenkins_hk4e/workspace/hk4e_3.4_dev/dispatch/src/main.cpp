// File: /data/jenkins/jenkins_hk4e/workspace/hk4e_3.4_dev/dispatch/src/main.cpp

// Line 24: range 000000000C61074A-000000000C610C25
int __cdecl main(int argc, const char **argv, const char **envp)
{
  ...
  *(_QWORD *)(v3 + 16) = main;
  ...
  std::string::assign(v3 + 32, "dispatch");
  ...
  std::string::append(v3 + 64, "22:59:47");
  *(_DWORD *)(v3 + 224) = 300;
  *(_DWORD *)(v3 + 228) = argc;
  *(_QWORD *)(v3 + 232) = argv;
