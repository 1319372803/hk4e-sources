// File: /data/jenkins/jenkins_hk4e/workspace/hk4e_3.4_dev/tothemoonserver/src/main.cpp

// Line 33: range 000000000CBABAA2-000000000CBABF7D
int __cdecl main(int argc, const char **argv, const char **envp)
{
  ...
  *(_QWORD *)(v3 + 16) = main;
  ...
  std::string::assign(v3 + 32, "tothemoonserver");
  ...
  std::string::append(v3 + 64, "23:03:49");
  *(_DWORD *)(v3 + 224) = 300;
  *(_DWORD *)(v3 + 228) = argc;
  *(_QWORD *)(v3 + 232) = argv;
