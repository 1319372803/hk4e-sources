// File: /data/jenkins/jenkins_hk4e/workspace/hk4e_3.4_dev/hk4e_data/src/json_data_auto/ConfigManekin.cpp

// Line 19: range 0000000012035A43-0000000012036895
bool __cdecl data::mapFromJson(const Json::Value *jval, data::ManekinEquipedRotationMap *m)
{
  bool v2; // r15
  ...
  int v18; // r14d
  std::pair<std::__detail::_Node_iterator<std::pair<int const,data::Vector>,false,false>,bool> v19; // rax
    ...
    *(_DWORD *)(((v3 + 144) >> 3) + 0x7FFF8000) = 0;
    ...
    if ( !fromJson<std::string>((const Json::Value *)(v3 + 608), (std::string *)(v3 + 144)) )
    {
      *(_DWORD *)(((v3 + 208) >> 3) + 0x7FFF8000) = 0;
      ...
      common::milog::MiLogStream::create(
        ...
        3u,
        "./src/json_data_auto/ConfigManekin.cpp",
        "mapFromJson",
        28);
    ...
    else
    {
      ...
      *(_BYTE *)(v3 + 124) = 0;
      ...
      {
        v19 = std::unordered_map<int,data::Vector>::emplace<int &,data::Vector&>(
                m,
                (int *)(v3 + 32),
                (data::Vector *)(v3 + 112),
                (int *)(v3 + 32),
...
// Line 54: range 0000000012036896-0000000012036B66
int32_t __cdecl data::getMapHashValue(const data::ManekinEquipedRotationMap *map)
{
  __int64 v1; // rsi
  ...
  int32_t result; // eax
  std::__detail::_Node_const_iterator<std::pair<int const,data::Vector>,false,false>::reference v7; // [rsp+18h] [rbp-B8h]
  int32_t *key; // [rsp+20h] [rbp-B0h]
  std::tuple_element<1,const std::pair<int const,data::Vector> >::type *val; // [rsp+28h] [rbp-A8h]
  ...
  *(std::unordered_map<int,data::Vector>::const_iterator *)(v2 + 64) = std::unordered_map<int,data::Vector>::begin(map);
  if ( *(_BYTE *)(((v2 + 96) >> 3) + 0x7FFF8000) )
    __asan_report_store8(v2 + 96, v1);
  *(std::unordered_map<int,data::Vector>::const_iterator *)(v2 + 96) = std::unordered_map<int,data::Vector>::end(map);
  while ( std::__detail::operator!=<std::pair<int const,data::Vector>,false>(
            (const std::__detail::_Node_iterator_base<std::pair<int const,data::Vector>,false> *)(v2 + 64),
            (const std::__detail::_Node_iterator_base<std::pair<int const,data::Vector>,false> *)(v2 + 96)) )
  {
    v7 = std::__detail::_Node_const_iterator<std::pair<int const,data::Vector>,false,false>::operator*((const std::__detail::_Node_const_iterator<std::pair<int const,data::Vector>,false,false> *const)(v2 + 64));
    key = std::get<0ul,int const,data::Vector>(v7);
    val = (std::tuple_element<1,const std::pair<int const,data::Vector> >::type *)std::get<1ul,int const,data::Vector>(v7);
    ...
    std::__detail::_Node_const_iterator<std::pair<int const,data::Vector>,false,false>::operator++((std::__detail::_Node_const_iterator<std::pair<int const,data::Vector>,false,false> *const)(v2 + 64));
  }
...
// Line 68: range 0000000012036B68-0000000012036EBD
bool __cdecl data::ConfigManekinEquip::fromJson(data::ConfigManekinEquip *const this, const Json::Value *jval)
{
  unsigned __int64 v2; // r12
  __int64 v3; // rax
  _DWORD *v4; // r13
  data::ConfigManekinEquip *v5; // rsi
  bool result; // al
  const Json::Value *equiped_rotation_ptr; // [rsp+18h] [rbp-E8h]
  ...
  *(_QWORD *)(v2 + 16) = data::ConfigManekinEquip::fromJson;
  v4 = (_DWORD *)(v2 >> 3);
  v4[536862720] = -235802127;
  ...
  v5 = (data::ConfigManekinEquip *)(v2 + 64);
  equiped_rotation_ptr = jsonValueFind(jval, (const std::string *)(v2 + 64));
  std::string::~string((void *)(v2 + 64));
  *(_DWORD *)(((v2 + 64) >> 3) + 0x7FFF8000) = -117901064;
  std::allocator<char>::~allocator(v2 + 48);
  *(_BYTE *)(((v2 + 48) >> 3) + 0x7FFF8000) = -8;
  if ( equiped_rotation_ptr && (v5 = this, !data::mapFromJson(equiped_rotation_ptr, &this->equiped_rotation)) )
  {
    *(_DWORD *)(((v2 + 128) >> 3) + 0x7FFF8000) = 0;
    ...
    common::milog::MiLogStream::operator<<<char [37],(char *[37])0>(
      ...
      (const char (*)[37])"fromJson for: equipedRotation fails!");
...
// Line 86: range 0000000012036EBE-0000000012036FF8
int32_t __cdecl data::ConfigManekinEquip::getHashValue(const data::ConfigManekinEquip *const this)
{
  __int64 v1; // rsi
  ...
  *(_QWORD *)(v2 + 16) = data::ConfigManekinEquip::getHashValue;
  v4 = v2 >> 3;
  ...
  *(_DWORD *)(v2 + 32) = 0;
  MapHashValue = data::getMapHashValue(&this->equiped_rotation);
...
// Line 93: range 0000000012036FF9-0000000012037DAA
bool __cdecl data::mapFromJson(const Json::Value *jval, data::ManekinEquipMap *m)
{
  bool v2; // r15
  unsigned __int64 v3; // r13
  __int64 v4; // rax
  ...
  _DWORD *v13; // rax
  data::ConfigManekinEquip *v14; // r8
  common::milog::MiLogStream *v15; // rax
  int v16; // r14d
  std::pair<std::__detail::_Node_iterator<std::pair<unsigned int const,data::ConfigManekinEquip>,false,false>,bool> v17; // rax
  ...
  *(_QWORD *)v3 = 1102416563LL;
  *(_QWORD *)(v3 + 8) = "13 32 4 6 key:98 48 16 6 cit:95 80 16 9 <unknown> 112 32 10 key_str:99 176 32 9 <unknown> 240 32"
                        " 9 <unknown> 304 32 9 <unknown> 368 32 9 <unknown> 432 32 9 <unknown> 496 40 11 tmp_jval:94 576 "
                        "40 11 key_jval:97 656 40 14 value_jval:110 736 64 9 value:111";
  *(_QWORD *)(v3 + 16) = data::mapFromJson;
  v5 = (_DWORD *)(v3 >> 3);
  v5[536862720] = -235802127;
  v5[536862721] = 61956;
  ...
  while ( 1 )
  {
    ...
    *(_DWORD *)(((v3 + 112) >> 3) + 0x7FFF8000) = 0;
    ...
    else
    {
      ...
      *v13 = 0;
      v13[1] = 0;
      data::ConfigManekinEquip::ConfigManekinEquip((data::ConfigManekinEquip *const)(v3 + 736));
      if ( !data::ConfigManekinEquip::fromJson(
              (data::ConfigManekinEquip *const)(v3 + 736),
      ...
      {
        v17 = std::unordered_map<unsigned int,data::ConfigManekinEquip>::emplace<unsigned int &,data::ConfigManekinEquip&>(
                m,
                (unsigned int *)(v3 + 32),
                (data::ConfigManekinEquip *)(v3 + 736),
                (unsigned int *)(v3 + 32),
                v14);
        if ( !v17.second )
        {
...
// Line 128: range 0000000012037DAB-000000001203807B
int32_t __cdecl data::getMapHashValue(const data::ManekinEquipMap *map)
{
  __int64 v1; // rsi
  unsigned __int64 v2; // r12
  __int64 v3; // rax
  ...
  int32_t HashValue; // eax
  int32_t result; // eax
  std::__detail::_Node_const_iterator<std::pair<unsigned int const,data::ConfigManekinEquip>,false,false>::reference v7; // [rsp+18h] [rbp-B8h]
  uint32_t *key; // [rsp+20h] [rbp-B0h]
  std::tuple_element<1,const std::pair<unsigned int const,data::ConfigManekinEquip> >::type *val; // [rsp+28h] [rbp-A8h]
  char v10[160]; // [rsp+30h] [rbp-A0h] BYREF
  ...
  *(_QWORD *)v2 = 1102416563LL;
  *(_QWORD *)(v2 + 8) = "3 48 4 13 hash_code:129 64 8 15 __for_begin:130 96 8 13 __for_end:130";
  *(_QWORD *)(v2 + 16) = data::getMapHashValue;
  v4 = (_DWORD *)(v2 >> 3);
  v4[536862720] = -235802127;
  v4[536862721] = -234556943;
  ...
  *(_DWORD *)(v2 + 48) = 0;
  if ( *(_BYTE *)(((v2 + 64) >> 3) + 0x7FFF8000) )
    __asan_report_store8(v2 + 64, v1);
  *(std::unordered_map<unsigned int,data::ConfigManekinEquip>::const_iterator *)(v2 + 64) = std::unordered_map<unsigned int,data::ConfigManekinEquip>::begin(map);
  if ( *(_BYTE *)(((v2 + 96) >> 3) + 0x7FFF8000) )
    __asan_report_store8(v2 + 96, v1);
  *(std::unordered_map<unsigned int,data::ConfigManekinEquip>::const_iterator *)(v2 + 96) = std::unordered_map<unsigned int,data::ConfigManekinEquip>::end(map);
  while ( std::__detail::operator!=<std::pair<unsigned int const,data::ConfigManekinEquip>,false>(
            (const std::__detail::_Node_iterator_base<std::pair<unsigned int const,data::ConfigManekinEquip>,false> *)(v2 + 64),
            (const std::__detail::_Node_iterator_base<std::pair<unsigned int const,data::ConfigManekinEquip>,false> *)(v2 + 96)) )
  {
    v7 = std::__detail::_Node_const_iterator<std::pair<unsigned int const,data::ConfigManekinEquip>,false,false>::operator*((const std::__detail::_Node_const_iterator<std::pair<unsigned int const,data::ConfigManekinEquip>,false,false> *const)(v2 + 64));
    key = std::get<0ul,unsigned int const,data::ConfigManekinEquip>(v7);
    val = (std::tuple_element<1,const std::pair<unsigned int const,data::ConfigManekinEquip> >::type *)std::get<1ul,unsigned int const,data::ConfigManekinEquip>(v7);
    if ( *(_BYTE *)(((unsigned __int64)key >> 3) + 0x7FFF8000) != 0
      && (char)(((unsigned __int8)key & 7) + 3) >= *(_BYTE *)(((unsigned __int64)key >> 3) + 0x7FFF8000) )
    {
      __asan_report_load4(key);
    ...
    common::tools::HashUtils::appendHash(*key, (int32_t *)(v2 + 48));
    HashValue = data::ConfigManekinEquip::getHashValue(val);
    common::tools::HashUtils::appendHash(HashValue, (int32_t *)(v2 + 48));
    std::__detail::_Node_const_iterator<std::pair<unsigned int const,data::ConfigManekinEquip>,false,false>::operator++((std::__detail::_Node_const_iterator<std::pair<unsigned int const,data::ConfigManekinEquip>,false,false> *const)(v2 + 64));
  }
  *(_BYTE *)(((v2 + 64) >> 3) + 0x7FFF8000) = -8;
  *(_BYTE *)(((v2 + 96) >> 3) + 0x7FFF8000) = -8;
  if ( *(_BYTE *)(((v2 + 48) >> 3) + 0x7FFF8000) != 0 && *(_BYTE *)(((v2 + 48) >> 3) + 0x7FFF8000) <= 3 )
...
// Line 142: range 000000001203807C-00000000120383D1
bool __cdecl data::ConfigManekin::fromJson(data::ConfigManekin *const this, const Json::Value *jval)
{
  unsigned __int64 v2; // r12
  __int64 v3; // rax
  _DWORD *v4; // r13
  data::ConfigManekin *v5; // rsi
  bool result; // al
  const Json::Value *equips_ptr; // [rsp+18h] [rbp-E8h]
  char v9[224]; // [rsp+20h] [rbp-E0h] BYREF
  ...
  *(_QWORD *)v2 = 1102416563LL;
  *(_QWORD *)(v2 + 8) = "3 48 1 9 <unknown> 64 32 9 <unknown> 128 32 9 <unknown>";
  *(_QWORD *)(v2 + 16) = data::ConfigManekin::fromJson;
  v4 = (_DWORD *)(v2 >> 3);
  v4[536862720] = -235802127;
  v4[536862721] = -234753551;
  v4[536862723] = -218959118;
  ...
  std::string::basic_string<std::allocator<char>>(
    ...
    "equips",
    (const std::allocator<char> *)(v2 + 48));
  v5 = (data::ConfigManekin *)(v2 + 64);
  equips_ptr = jsonValueFind(jval, (const std::string *)(v2 + 64));
  std::string::~string((void *)(v2 + 64));
  *(_DWORD *)(((v2 + 64) >> 3) + 0x7FFF8000) = -117901064;
  std::allocator<char>::~allocator(v2 + 48);
  *(_BYTE *)(((v2 + 48) >> 3) + 0x7FFF8000) = -8;
  if ( equips_ptr && (v5 = this, !data::mapFromJson(equips_ptr, &this->equips)) )
  {
    *(_DWORD *)(((v2 + 128) >> 3) + 0x7FFF8000) = 0;
    if ( *(char *)(((v2 + 128) >> 3) + 0x7FFF8000) < 0
      || *(_BYTE *)(((v2 + 159) >> 3) + 0x7FFF8000) != 0
    ...
    common::milog::MiLogStream::operator<<<char [28],(char *[28])0>(
      (common::milog::MiLogStream *const)(v2 + 128),
      (const char (*)[28])"fromJson for: equips fails!");
    common::milog::MiLogStream::~MiLogStream((common::milog::MiLogStream *const)(v2 + 128));
    result = 0;
  }
  else
...
// Line 160: range 00000000120383D2-000000001203850C
int32_t __cdecl data::ConfigManekin::getHashValue(const data::ConfigManekin *const this)
{
  __int64 v1; // rsi
  unsigned __int64 v2; // rbx
  __int64 v3; // rax
  ...
  *(_QWORD *)v2 = 1102416563LL;
  *(_QWORD *)(v2 + 8) = "1 32 4 13 hash_code:161";
  *(_QWORD *)(v2 + 16) = data::ConfigManekin::getHashValue;
  v4 = v2 >> 3;
  *(_DWORD *)(v4 + 2147450880) = -235802127;
  *(_DWORD *)(v4 + 2147450884) = -202116348;
  if ( *(_BYTE *)(((v2 + 32) >> 3) + 0x7FFF8000) != 0 && *(_BYTE *)(((v2 + 32) >> 3) + 0x7FFF8000) <= 3 )
    __asan_report_store4(v2 + 32, v1);
  *(_DWORD *)(v2 + 32) = 0;
  MapHashValue = data::getMapHashValue(&this->equips);
  common::tools::HashUtils::appendHash(MapHashValue, (int32_t *)(v2 + 32));
  if ( *(_BYTE *)(((v2 + 32) >> 3) + 0x7FFF8000) != 0 && *(_BYTE *)(((v2 + 32) >> 3) + 0x7FFF8000) <= 3 )
    __asan_report_load4(v2 + 32);
  result = *(_DWORD *)(v2 + 32);
