// File: /data/jenkins/jenkins_hk4e/workspace/hk4e_3.4_dev/hk4e_data/src/json_data_auto/ConfigIPhoneXData.h

// Line 16: range 0000000012141DBA-00000000121420C3
void __cdecl data::ConfigIPhoneXAction::ConfigIPhoneXAction(data::ConfigIPhoneXAction *const this)
{
  __int64 v1; // rsi
  __int64 v2; // rsi
  __int64 v3; // rsi
...
// Line 16: range 0000000012613864-0000000012613E37
void __cdecl data::ConfigIPhoneXAction::ConfigIPhoneXAction(
        data::ConfigIPhoneXAction *const this,
        const data::ConfigIPhoneXAction *a2)
{
  float indent; // xmm0_4
  float scale; // xmm0_4
  __int64 v4; // rsi
...
// Line 16: range 00000000121420C4-00000000121420EE
void __cdecl data::ConfigIPhoneXAction::~ConfigIPhoneXAction(data::ConfigIPhoneXAction *const this)
{
