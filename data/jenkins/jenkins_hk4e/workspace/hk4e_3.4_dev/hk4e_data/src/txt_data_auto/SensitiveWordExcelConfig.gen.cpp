// File: /data/jenkins/jenkins_hk4e/workspace/hk4e_3.4_dev/hk4e_data/src/txt_data_auto/SensitiveWordExcelConfig.gen.cpp

// Line 13: range 000000001470F096-000000001470F61E
int32_t __cdecl data::SensitiveWordConfig::init(
        ...
        const common::tools::TxtFile::Row *row)
{
  ...
  *(_QWORD *)(v2 + 16) = data::SensitiveWordConfig::init;
  v4 = (_DWORD *)(v2 >> 3);
  ...
  *(_BYTE *)(((v2 + 32) >> 3) + 0x7FFF8000) = -8;
  if ( v5 )
  {
    *(_DWORD *)(((v2 + 128) >> 3) + 0x7FFF8000) = 0;
    ...
    common::milog::MiLogStream::create(
      ...
      4u,
      "./src/txt_data_auto/SensitiveWordExcelConfig.gen.cpp",
      "init",
      16);
  ...
  else
  {
    ...
    *(_BYTE *)(((v2 + 48) >> 3) + 0x7FFF8000) = 1;
    ...
    v8 = common::tools::TxtFile::Row::assignToStr(row, (const std::string *)(v2 + 192), &this->word) != 0;
    ...
    if ( v8 )
    {
      *(_DWORD *)(((v2 + 256) >> 3) + 0x7FFF8000) = 0;
      ...
      v9 = common::milog::MiLogStream::operator<<<char [16],(char *[16])0>(
             ...
             (const char (*)[16])"[CONFIG_ERROR] ");
      common::milog::MiLogStream::operator<<<char [30],(char *[30])0>(v9, (const char (*)[30])byte_1ADE5E00);
...
// Line 30: range 000000001470F620-0000000014710A30
int32_t __cdecl data::SensitiveWordExcelConfigMgrBase::loadSensitiveWordConfig(
        data::SensitiveWordExcelConfigMgrBase *const this,
        HK4EDesignConfig *config)
{
  ...
  data::SensitiveWordConfig *v40; // rax
  data::SensitiveWordConfig *v41; // rdx
  ...
  *(_QWORD *)(v3 + 8) = "17 32 1 9 <unknown> 48 4 4 r:45 64 4 9 <unknown> 80 8 14 __for_begin:60 112 8 12 __for_end:60 14"
                        "4 8 9 <unknown> 176 8 4 i:64 208 32 8 paths:31 272 32 9 <unknown> 336 32 9 <unknown> 400 32 9 <u"
                        "nknown> 464 32 9 <unknown> 528 32 9 <unknown> 592 48 7 data:48 672 48 18 col_id_name_map:59 752 "
                        "376 23 debug_message_stream:56 1200 32880 11 txt_file:39";
  *(_QWORD *)(v3 + 16) = data::SensitiveWordExcelConfigMgrBase::loadSensitiveWordConfig;
  v5 = (_DWORD *)(v3 >> 3);
    ...
    else
    {
      *(_BYTE *)(((v3 + 48) >> 3) + 0x7FFF8000) = 4;
      ...
      for ( *(_DWORD *)(v3 + 48) = 0; ; ++*(_DWORD *)(v3 + 48) )
      {
        ...
        *(_DWORD *)v13 = 0;
        *(_WORD *)(v13 + 4) = 0;
        data::SensitiveWordConfig::SensitiveWordConfig((data::SensitiveWordConfig *const)(v3 + 592));
        if ( row_ptr )
        {
          if ( data::SensitiveWordConfig::init((data::SensitiveWordConfig *const)(v3 + 592), row_ptr) )
          {
          ...
          {
            v40 = std::move<data::SensitiveWordConfig &>((data::SensitiveWordConfig *)(v3 + 592));
            std::vector<data::SensitiveWordConfig>::emplace_back<data::SensitiveWordConfig>(
              &this->sensitive_word_config_vec,
              v40,
              v41);
            v15 = 1;
          }
...
// Line 86: range 0000000014710A32-0000000014710C15
int32_t __cdecl data::SensitiveWordExcelConfigMgrBase::loadConfig(
        data::SensitiveWordExcelConfigMgrBase *const this,
        HK4EDesignConfig *config)
{
  ...
  *(_QWORD *)(v2 + 16) = data::SensitiveWordExcelConfigMgrBase::loadConfig;
  v4 = v2 >> 3;
  *(_DWORD *)(v4 + 2147450880) = -235802127;
  *(_DWORD *)(v4 + 2147450888) = -202116109;
  if ( data::SensitiveWordExcelConfigMgrBase::loadSensitiveWordConfig(this, config) )
  {
    ...
    common::milog::MiLogStream::operator<<<char [31],(char *[31])0>(
      v5,
      (const char (*)[31])"loadSensitiveWordConfig failed");
...
// Line 96: range 0000000014710C16-0000000014710C28
int32_t __cdecl data::SensitiveWordExcelConfigMgrBase::rewriteConfig(
        data::SensitiveWordExcelConfigMgrBase *const this,
...
// Line 101: range 0000000014710C2A-0000000014710C3C
int32_t __cdecl data::SensitiveWordExcelConfigMgrBase::finalConfig(
        data::SensitiveWordExcelConfigMgrBase *const this,
        TxtConfigMgr *txt_config_mgr)
{
  return 0;
