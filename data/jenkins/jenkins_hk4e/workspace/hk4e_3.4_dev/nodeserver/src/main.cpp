// File: /data/jenkins/jenkins_hk4e/workspace/hk4e_3.4_dev/nodeserver/src/main.cpp

// Line 22: range 0000000003845782-0000000003845C5D
int __cdecl main(int argc, const char **argv, const char **envp)
{
  ...
  {
    v4 = __asan_stack_malloc_3(384LL, argv, envp);
    if ( v4 )
      v3 = v4;
  }
  *(_QWORD *)v3 = 1102416563LL;
  *(_QWORD *)(v3 + 8) = "1 32 288 13 app_config:26";
  *(_QWORD *)(v3 + 16) = main;
  v5 = (_DWORD *)(v3 >> 3);
  ...
  std::string::assign(v3 + 32, "nodeserver");
  ...
  std::string::append(v3 + 64, "22:57:32");
  *(_DWORD *)(v3 + 224) = 300;
  *(_DWORD *)(v3 + 228) = argc;
  *(_QWORD *)(v3 + 232) = argv;
