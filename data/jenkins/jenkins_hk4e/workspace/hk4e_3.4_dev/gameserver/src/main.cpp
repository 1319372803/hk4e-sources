// File: /data/jenkins/jenkins_hk4e/workspace/hk4e_3.4_dev/gameserver/src/main.cpp

// Line 23: range 00000000175A326F-00000000175A374A
int __cdecl main(int argc, const char **argv, const char **envp)
{
  ...
  *(_QWORD *)(v3 + 16) = main;
  ...
  std::string::assign(v3 + 32, "gameserver");
  std::string::assign(v3 + 96, &off_26142E60);
  ...
  std::string::append(v3 + 64, &off_26142F20);
  std::string::append(v3 + 64, " ");
  std::string::append(v3 + 64, "23:11:01");
  *(_DWORD *)(v3 + 224) = 300;
  *(_DWORD *)(v3 + 228) = argc;
  *(_QWORD *)(v3 + 232) = argv;
