// File: /data/jenkins/jenkins_hk4e/workspace/hk4e_3.4_dev/gameserver/src/scene/scene_gallery/lan_v3_boat_game_single_gallery.cpp

// Line 25: range 00000000145D0C80-00000000145D0CA5
void __cdecl LanV3BoatGameSingleGallery::toClient(
...
// Line 30: range 00000000145D0CA6-00000000145D0DA8
void __cdecl LanV3BoatGameSingleGallery::onStart(LanV3BoatGameSingleGallery *const this)
{
  ...
  if ( std::map<unsigned int,proto::OnlinePlayerInfo>::size(&this->player_info_map_) > 1 )
  {
    common::milog::MiLogStream::create(
      ...
      3u,
      "./src/scene/scene_gallery/lan_v3_boat_game_single_gallery.cpp",
      "onStart",
      34);
    v1 = common::milog::MiLogStream::operator<<<char [66],(char *[66])0>(
           &v5,
           (const char (*)[66])"[LAN_V3_BOAT] single boat gallery player count > 1. player count:");
  ...
  LanV3BoatGameSingleGallery::clearGalleryData(this);
  LanV3BoatGameSingleGallery::printGalleryStartLog(this);
};

// Line 41: range 00000000145D0DAA-00000000145D0DD8
void __cdecl LanV3BoatGameSingleGallery::onStop(
        LanV3BoatGameSingleGallery *const this,
        proto::GalleryStopReason reason)
{
  LanV3BoatGameSingleGallery::printGalleryStopLog(this, reason);
  LanV3BoatGameSingleGallery::clearGalleryData(this);
};

// Line 47: range 00000000145D0DDA-00000000145D150B
int32_t __cdecl LanV3BoatGameSingleGallery::updatePlayerScore(
        LanV3BoatGameSingleGallery *const this,
        uint32_t uid,
        ...
        const ScriptContext *contex)
{
  ...
  LanV3BoatMultistagePlay *v22; // rax
  LanV3BoatMultistagePlay *v23; // rax
  std::__shared_ptr_access<LanV3BoatMultistagePlay,(__gnu_cxx::_Lock_policy)2,false,false>::element_type *v24; // rax
  int32_t result; // eax
  ...
  *(_QWORD *)(v4 + 8) = "3 32 1 10 is_succ:65 48 16 11 play_ptr:53 80 48 17 winner_uid_set:71";
  *(_QWORD *)(v4 + 16) = LanV3BoatGameSingleGallery::updatePlayerScore;
  v6 = (_DWORD *)(v4 >> 3);
    ...
    else
    {
      ...
      if ( (*(unsigned int (__fastcall **)(unsigned __int64))v12)(v11) == 17 )
      {
        *(_BYTE *)(v4 + 32) = 0;
        ...
        std::string::basic_string<std::allocator<char>>((std::string *const)&v30, "is_succ", &__a);
        ...
        if ( v19 )
        {
          ...
          v20 = common::milog::MiLogStream::operator<<<char [43],(char *[43])0>(
                  &v30,
                  (const char (*)[43])"[LAN_V3_BOAT] is_succ didnt update! [uid: ");
        ...
        else
        {
          ...
          std::set<unsigned int>::insert((std::set<unsigned int> *const)(v4 + 80), &val);
          v22 = std::__shared_ptr_access<LanV3BoatMultistagePlay,(__gnu_cxx::_Lock_policy)2,false,false>::operator->((const std::__shared_ptr_access<LanV3BoatMultistagePlay,(__gnu_cxx::_Lock_policy)2,false,false> *const)(v4 + 48));
          LanV3BoatMultistagePlay::setWinnerUidSet(v22, (const std::set<unsigned int> *)(v4 + 80));
          v23 = std::__shared_ptr_access<LanV3BoatMultistagePlay,(__gnu_cxx::_Lock_policy)2,false,false>::operator->((const std::__shared_ptr_access<LanV3BoatMultistagePlay,(__gnu_cxx::_Lock_policy)2,false,false> *const)(v4 + 48));
          LanV3BoatMultistagePlay::setIsGallerySucc(v23, *(_BYTE *)(v4 + 32));
          ...
          SceneMultistagePlay::endStage(v24, 1);
          v8 = 0;
          std::set<unsigned int>::~set((std::set<unsigned int> *const)(v4 + 80));
        }
      }
...
// Line 82: range 00000000145D150C-00000000145D1516
void __cdecl LanV3BoatGameSingleGallery::clearGalleryData(LanV3BoatGameSingleGallery *const this)
{
  ;
};

// Line 87: range 00000000145D1518-00000000145D1522
void __cdecl LanV3BoatGameSingleGallery::printGalleryStartLog(LanV3BoatGameSingleGallery *const this)
{
  ;
};

// Line 92: range 00000000145D1524-00000000145D1531
void __cdecl LanV3BoatGameSingleGallery::printGalleryStopLog(
        LanV3BoatGameSingleGallery *const this,
        proto::GalleryStopReason reason)
{
  ;
