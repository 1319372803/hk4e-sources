// File: /data/jenkins/jenkins_hk4e/workspace/hk4e_3.4_dev/gameserver/src/scene/scene_gallery/broken_floor_gallery.cpp

// Line 25: range 00000000179CFA64-00000000179CFC0D
void __cdecl BrokenFloorGallery::toClient(BrokenFloorGallery *const this, proto::SceneGalleryInfo *client_info)
{
  ...
  proto::SceneGalleryBrokenFloorInfo *broken_floor_info; // [rsp+20h] [rbp-40h]
  google::protobuf::Map<unsigned int,unsigned int> *proto_fall_count_map; // [rsp+28h] [rbp-38h]
  ...
  std::tuple_element<1,const std::pair<unsigned int const,unsigned int> >::type *fall_count; // [rsp+48h] [rbp-18h]

  BaseGallery::toClient(this, client_info);
  broken_floor_info = proto::SceneGalleryInfo::mutable_broken_floor_info(client_info);
  proto_fall_count_map = proto::SceneGalleryBrokenFloorInfo::mutable_fall_count_map(broken_floor_info);
  __for_range = &this->fall_count_map_;
  __for_begin._M_cur = std::unordered_map<unsigned int,unsigned int>::begin(&this->fall_count_map_)._M_cur;
  __for_end._M_cur = std::unordered_map<unsigned int,unsigned int>::end(&this->fall_count_map_)._M_cur;
  while ( std::__detail::operator!=<std::pair<unsigned int const,unsigned int>,false>(&__for_begin, &__for_end) )
  {
    ...
    fall_count = (std::tuple_element<1,const std::pair<unsigned int const,unsigned int> >::type *)std::get<1ul,unsigned int const,unsigned int>(v12);
    if ( *(_BYTE *)(((unsigned __int64)fall_count >> 3) + 0x7FFF8000) != 0
      && (char)(((unsigned __int8)fall_count & 7) + 3) >= *(_BYTE *)(((unsigned __int64)fall_count >> 3) + 0x7FFF8000) )
    {
      __asan_report_load4();
    }
    v2 = *fall_count;
    v3 = uid;
    v4 = google::protobuf::Map<unsigned int,unsigned int>::operator[](proto_fall_count_map, uid);
    v5 = v4;
  ...
  proto::SceneGalleryBrokenFloorInfo::set_end_time(broken_floor_info, this->end_time_);
};

// Line 37: range 00000000179CFC0E-00000000179D0277
__int64 __fastcall BrokenFloorGallery::updatePlayerScore(
        BrokenFloorGallery *const this,
        uint32_t uid,
        ...
        const ScriptContext *contex)
{
  ...
  *(_QWORD *)(v4 + 8) = "4 32 4 17 add_fall_count:57 48 4 6 uid:36 64 16 13 player_ptr:44 96 32 9 notify:65";
  *(_QWORD *)(v4 + 16) = BrokenFloorGallery::updatePlayerScore;
  v6 = (_DWORD *)(v4 >> 3);
  ...
  if ( this->stage_ == START )
  {
    ...
    if ( std::operator==<Player>(0LL, (const std::shared_ptr<Player> *)(v4 + 64)) )
    {
      common::milog::MiLogStream::create(
        ...
        3u,
        "./src/scene/scene_gallery/broken_floor_gallery.cpp",
        "updatePlayerScore",
        47);
    ...
    else
    {
      *(_DWORD *)(v4 + 32) = 0;
      ...
      std::string::basic_string<std::allocator<char>>((std::string *const)(v4 + 96), "add_fall_count", &__a);
      ...
      else
      {
        ...
        *(_DWORD *)v13 += *(_DWORD *)(v4 + 32);
        proto::GalleryBrokenFloorFallNotify::GalleryBrokenFloorFallNotify((proto::GalleryBrokenFloorFallNotify *const)(v4 + 96));
        if ( *(_BYTE *)(((unsigned __int64)&this->gallery_id_ >> 3) + 0x7FFF8000) != 0
          && *(_BYTE *)(((unsigned __int64)&this->gallery_id_ >> 3) + 0x7FFF8000) <= 3 )
        {
          __asan_report_load4();
        }
        proto::GalleryBrokenFloorFallNotify::set_gallery_id(
          (proto::GalleryBrokenFloorFallNotify *const)(v4 + 96),
          this->gallery_id_);
        ...
        proto::GalleryBrokenFloorFallNotify::set_fall_count((proto::GalleryBrokenFloorFallNotify *const)(v4 + 96), *v14);
