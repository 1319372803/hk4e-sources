// File: /data/jenkins/jenkins_hk4e/workspace/hk4e_3.4_dev/pathfindingserver/src/main.cpp

// Line 33: range 000000000CB59CEE-000000000CB5A1C9
int __cdecl main(int argc, const char **argv, const char **envp)
{
  ...
  *(_QWORD *)(v3 + 8) = "1 32 288 14 base_config:37";
  *(_QWORD *)(v3 + 16) = main;
  v5 = (_DWORD *)(v3 >> 3);
  ...
  std::string::assign(v3 + 32, "pathfindingserver");
  ...
  std::string::append(v3 + 64, "23:02:30");
  *(_DWORD *)(v3 + 224) = 300;
  *(_DWORD *)(v3 + 228) = argc;
  *(_QWORD *)(v3 + 232) = argv;
