...
#ifndef PROTOBUF_server_5fonly_2fcmd_5fid_5fconfig_2eproto__INCLUDED
#define PROTOBUF_server_5fonly_2fcmd_5fid_5fconfig_2eproto__INCLUDED
...
enum CmdIdConfig {
  ...
  CmdIdConfig_INT_MIN_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32min,
  CmdIdConfig_INT_MAX_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32max
};
bool CmdIdConfig_IsValid(int value);
const CmdIdConfig CmdIdConfig_MIN = CMD_MISC_BEGIN;
const CmdIdConfig CmdIdConfig_MAX = CMD_ACTIVITY_END_3;
const int CmdIdConfig_ARRAYSIZE = CmdIdConfig_MAX + 1;

const ::google::protobuf::EnumDescriptor* CmdIdConfig_descriptor();
inline const ::std::string& CmdIdConfig_Name(CmdIdConfig value) {
  return ::google::protobuf::internal::NameOfEnum(
    CmdIdConfig_descriptor(), value);
}
inline bool CmdIdConfig_Parse(
    const ::std::string& name, CmdIdConfig* value) {
  return ::google::protobuf::internal::ParseNamedEnum<CmdIdConfig>(
    CmdIdConfig_descriptor(), name, value);
}
// ===================================================================
...
template <> struct is_proto_enum< ::proto::CmdIdConfig> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::proto::CmdIdConfig>() {
  return ::proto::CmdIdConfig_descriptor();
}
...
#endif  // PROTOBUF_server_5fonly_2fcmd_5fid_5fconfig_2eproto__INCLUDED
