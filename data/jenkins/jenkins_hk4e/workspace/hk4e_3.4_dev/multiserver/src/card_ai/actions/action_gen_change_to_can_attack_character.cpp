// File: /data/jenkins/jenkins_hk4e/workspace/hk4e_3.4_dev/multiserver/src/card_ai/actions/action_gen_change_to_can_attack_character.cpp

// Line 25: range 000000000D7D6052-000000000D7D695F
BT::NodeStatus __cdecl BT::ActionGenChangeToCanAttackCharacter::tick(
        BT::ActionGenChangeToCanAttackCharacter *const this)
{
  ...
  const std::shared_ptr<BTActionGenChangeToCanAttackCharacterConfig> *node_config_ptr; // [rsp+30h] [rbp-210h]
  ...
  *(_QWORD *)(v1 + 16) = BT::ActionGenChangeToCanAttackCharacter::tick;
  v3 = (_DWORD *)(v1 >> 3);
  ...
  std::dynamic_pointer_cast<BTActionGenChangeToCanAttackCharacterConfig,BTNodeConfigBase>(&__r);
  node_config_ptr = (const std::shared_ptr<BTActionGenChangeToCanAttackCharacterConfig> *)&__r;
  if ( std::operator==<BTActionGenChangeToCanAttackCharacterConfig>(
         (const std::shared_ptr<BTActionGenChangeToCanAttackCharacterConfig> *)&__r,
         0LL) )
  {
    common::milog::MiLogStream::create(
      ...
      4u,
      "./src/card_ai/actions/action_gen_change_to_can_attack_character.cpp",
      "tick",
      30);
    common::milog::MiLogStream::operator<<<char [63],(char *[63])0>(
      &v27,
      (const char (*)[63])"ActionGenChangeToCanAttackCharacter node_config_ptr is nullptr");
  ...
  else
  {
    ...
    if ( std::operator==<BT::Blackboard>((const std::shared_ptr<BT::Blackboard> *)(v1 + 64), 0LL) )
    {
      common::milog::MiLogStream::create(
        ...
        "tick",
        36);
      v5 = common::milog::MiLogStream::operator<<<char [69],(char *[69])0>(
             (common::milog::MiLogStream *const)(v1 + 320),
             (const char (*)[69])"ActionGenChangeToCanAttackCharacter blackboard_ptr is nullptr, name:");
      ...
      else
      {
        ...
        *(_DWORD *)(v1 + 48) = GCGControllerBase::getControllerId(v10);
        ...
        if ( std::operator!=<BT::ActionPlanMgr>((const std::shared_ptr<BT::ActionPlanMgr> *)(v1 + 128), 0LL) )
        {
          ...
          BT::ActionPlanMgr::createChangeToCanAttackCharacterPlan(
  ...
  std::shared_ptr<BTActionGenChangeToCanAttackCharacterConfig>::~shared_ptr((std::shared_ptr<BTActionGenChangeToCanAttackCharacterConfig> *const)&__r);
  result = v4;
  if ( v28 == (char *)v1 )
  {
