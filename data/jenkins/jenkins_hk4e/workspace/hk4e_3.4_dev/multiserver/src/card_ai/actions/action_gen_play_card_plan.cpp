// File: /data/jenkins/jenkins_hk4e/workspace/hk4e_3.4_dev/multiserver/src/card_ai/actions/action_gen_play_card_plan.cpp

// Line 28: range 000000000DE7EDDC-000000000DE7F66E
BT::NodeStatus __cdecl BT::ActionGenPlayCardPlan::tick(BT::ActionGenPlayCardPlan *const this)
{
  ...
  const std::shared_ptr<BTActionGenPlayCardPlanConfig> *node_config_ptr; // [rsp+30h] [rbp-210h]
  ...
  *(_QWORD *)(p_M_refcount + 16) = BT::ActionGenPlayCardPlan::tick;
  ...
  std::dynamic_pointer_cast<BTActionGenPlayCardPlanConfig,BTNodeConfigBase>(&__r);
  node_config_ptr = (const std::shared_ptr<BTActionGenPlayCardPlanConfig> *)&__r;
  std::shared_ptr<BTNodeConfigBase>::~shared_ptr((std::shared_ptr<BTNodeConfigBase> *const)&v26);
  if ( std::operator==<BTActionGenPlayCardPlanConfig>((const std::shared_ptr<BTActionGenPlayCardPlanConfig> *)&__r, 0LL) )
  {
    common::milog::MiLogStream::create(
      (common::milog::MiLogStream *)(p_M_refcount + 320),
      &common::milog::MiLogDefault::default_log_obj_,
      4u,
      "./src/card_ai/actions/action_gen_play_card_plan.cpp",
      "tick",
      33);
    common::milog::MiLogStream::operator<<<char [49],(char *[49])0>(
      (common::milog::MiLogStream *const)(p_M_refcount + 320),
      (const char (*)[49])"ActionGenPlayCardPlan node_config_ptr is nullptr");
  ...
  else
  {
    ...
    if ( std::operator==<BT::Blackboard>((const std::shared_ptr<BT::Blackboard> *)(p_M_refcount + 64), 0LL) )
    {
      ...
      v5 = common::milog::MiLogStream::operator<<<char [55],(char *[55])0>(
             ...
             (const char (*)[55])"ActionGenPlayCardPlan blackboard_ptr is nullptr, name:");
      ...
      else
      {
        ...
        *(_DWORD *)(p_M_refcount + 48) = GCGControllerBase::getControllerId(v10);
        ...
        if ( std::operator!=<BT::ActionPlanMgr>((const std::shared_ptr<BT::ActionPlanMgr> *)(p_M_refcount + 128), 0LL) )
        {
          ...
          BT::ActionPlanMgr::createPlayCardPlan(
  ...
  std::shared_ptr<BTActionGenPlayCardPlanConfig>::~shared_ptr((std::shared_ptr<BTActionGenPlayCardPlanConfig> *const)&__r);
  result = v4;
