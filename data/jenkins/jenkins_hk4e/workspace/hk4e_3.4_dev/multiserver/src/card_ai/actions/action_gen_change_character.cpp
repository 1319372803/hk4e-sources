// File: /data/jenkins/jenkins_hk4e/workspace/hk4e_3.4_dev/multiserver/src/card_ai/actions/action_gen_change_character.cpp

// Line 24: range 000000000D7D5744-000000000D7D6051
BT::NodeStatus __cdecl BT::ActionGenChangeCharacterPlan::tick(BT::ActionGenChangeCharacterPlan *const this)
{
  ...
  const std::shared_ptr<BTActionGenChangeCharacterPlanConfig> *node_config_ptr; // [rsp+30h] [rbp-210h]
  ...
  *(_QWORD *)(v1 + 8) = "8 48 4 20 cur_controller_id:51 64 16 17 blackboard_ptr:32 96 16 17 controller_ptr:38 128 16 15 p"
                        "lan_mgr_ptr:53 160 16 11 plan_ptr:63 192 24 15 plan_ptr_vec:62 256 32 19 global_logic_key:39 320"
                        " 32 25 global_action_plan_key:54";
  *(_QWORD *)(v1 + 16) = BT::ActionGenChangeCharacterPlan::tick;
  v3 = (_DWORD *)(v1 >> 3);
  ...
  std::dynamic_pointer_cast<BTActionGenChangeCharacterPlanConfig,BTNodeConfigBase>(&__r);
  node_config_ptr = (const std::shared_ptr<BTActionGenChangeCharacterPlanConfig> *)&__r;
  if ( std::operator==<BTActionGenChangeCharacterPlanConfig>(
         (const std::shared_ptr<BTActionGenChangeCharacterPlanConfig> *)&__r,
         0LL) )
  {
    common::milog::MiLogStream::create(
      ...
      4u,
      "./src/card_ai/actions/action_gen_change_character.cpp",
      "tick",
      29);
    common::milog::MiLogStream::operator<<<char [56],(char *[56])0>(
      &v27,
      (const char (*)[56])"ActionGenChangeCharacterPlan node_config_ptr is nullptr");
  ...
  else
  {
    ...
    if ( std::operator==<BT::Blackboard>((const std::shared_ptr<BT::Blackboard> *)(v1 + 64), 0LL) )
    {
      ...
      v5 = common::milog::MiLogStream::operator<<<char [62],(char *[62])0>(
             ...
             (const char (*)[62])"ActionGenChangeCharacterPlan blackboard_ptr is nullptr, name:");
  ...
  std::shared_ptr<BTActionGenChangeCharacterPlanConfig>::~shared_ptr((std::shared_ptr<BTActionGenChangeCharacterPlanConfig> *const)&__r);
  result = v4;
  if ( v28 == (char *)v1 )
  {
