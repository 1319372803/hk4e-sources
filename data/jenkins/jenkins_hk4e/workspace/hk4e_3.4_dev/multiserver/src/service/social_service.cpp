// File: /data/jenkins/jenkins_hk4e/workspace/hk4e_3.4_dev/multiserver/src/service/social_service.cpp

// Line 19: range 000000000DE8EE80-000000000DE8F0CC
int32_t __cdecl SocialService::init(SocialService *const this, common::tools::PTree *pt)
{
  ...
  *(_QWORD *)(v2 + 8) = "1 32 8 8 ms_pt:21";
  *(_QWORD *)(v2 + 16) = SocialService::init;
  v4 = v2 >> 3;
  ...
  *(_DWORD *)(v4 + 2147450884) = -202116352;
  ...
  else if ( ServiceBase::addHandler<SocialHandler>(this) )
  {
    common::milog::MiLogStream::create(
      (common::milog::MiLogStream *)&child_name,
      &common::milog::MiLogDefault::default_log_obj_,
      4u,
      "./src/service/social_service.cpp",
      "init",
      30);
    common::milog::MiLogStream::operator()((common::milog::MiLogStream *const)&child_name, off_1BB4A040);
...
// Line 37: range 000000000DE8F0CE-000000000DE8F165
int32_t __cdecl SocialService::onWorkThreadStart(SocialService *const this, uint32_t thread_index)
{
...
// Line 48: range 000000000DE8F166-000000000DE8F180
int32_t __cdecl SocialService::onWorkThreadStop(SocialService *const this, uint32_t thread_index)
{
  mysqlpp::Connection::thread_end();
  return 0;
};

// Line 56: range 000000000DE8F182-000000000DE8F354
ConfigPtr __cdecl SocialService::getConfig(SocialService *const this)
{
  ...
  v1->_M_refcount._M_pi = (std::_Sp_counted_base<(__gnu_cxx::_Lock_policy)2> *)"1 32 16 11 base_ptr:58";
  v1[1]._M_ptr = (std::__shared_ptr<ConfigBase,(__gnu_cxx::_Lock_policy)2>::element_type *)SocialService::getConfig;
