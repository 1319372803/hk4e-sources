// File: /data/jenkins/jenkins_hk4e/workspace/hk4e_3.4_dev/multiserver/src/service/offline_msg_service.cpp

// Line 20: range 000000000DE8E63C-000000000DE8E888
int32_t __cdecl OfflineMsgService::init(OfflineMsgService *const this, common::tools::PTree *pt)
{
  ...
  *(_QWORD *)(v2 + 16) = OfflineMsgService::init;
  v4 = v2 >> 3;
  ...
  *(_DWORD *)(v4 + 2147450884) = -202116352;
  ...
  else if ( ServiceBase::addHandler<OfflineMsgHandler>(this) )
  {
    common::milog::MiLogStream::create(
      (common::milog::MiLogStream *)&child_name,
      &common::milog::MiLogDefault::default_log_obj_,
      4u,
      "./src/service/offline_msg_service.cpp",
      "init",
      31);
    common::milog::MiLogStream::operator()((common::milog::MiLogStream *const)&child_name, off_1BB49DE0);
...
// Line 39: range 000000000DE8E88A-000000000DE8EA5C
ConfigPtr __cdecl OfflineMsgService::getConfig(OfflineMsgService *const this)
{
  ...
  if ( _asan_option_detect_stack_use_after_return )
  {
    this = (OfflineMsgService *const)64;
  ...
  v1[1]._M_ptr = (std::__shared_ptr<ConfigBase,(__gnu_cxx::_Lock_policy)2>::element_type *)OfflineMsgService::getConfig;
