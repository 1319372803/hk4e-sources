// File: /data/jenkins/jenkins_hk4e/workspace/hk4e_3.4_dev/multiserver/src/main.cpp

// Line 24: range 000000000D7CBF29-000000000D7CC404
int __cdecl main(int argc, const char **argv, const char **envp)
{
  ...
  common::midb::MySqlMgrT<std::mutex> *v7; // rax
  common::midb::RedisMgr *v8; // rax
  MonitorReport *v9; // rax
  int result; // eax
  ...
  *(_QWORD *)(v3 + 8) = "1 32 288 13 app_config:28";
  *(_QWORD *)(v3 + 16) = main;
  v5 = (_DWORD *)(v3 >> 3);
  ...
  std::string::assign(v3 + 32, "multiserver");
  ...
  std::string::append(v3 + 64, &off_1BA23000);
  std::string::append(v3 + 64, " ");
  std::string::append(v3 + 64, "23:00:06");
  *(_DWORD *)(v3 + 224) = 300;
  *(_DWORD *)(v3 + 228) = argc;
  *(_QWORD *)(v3 + 232) = argv;
