// File: /data/jenkins/jenkins_hk4e/workspace/hk4e_3.4_dev/gateserver/src/network/tothemoonserver_connect.cpp

// Line 20: range 000000000C75CC20-000000000C75D13B
int32_t __cdecl TothemoonserverConnect::onRecv(
        ...
        boost::asio::yield_context *p_yield)
{
  ...
  *(_QWORD *)(v4 + 8) = "5 48 4 15 gate_recv_ms:34 64 8 15 game_recv_ms:36 96 8 15 game_send_ms:37 128 8 9 now_ms:38 160 "
                        "16 13 packet_ptr:21";
  *(_QWORD *)(v4 + 16) = TothemoonserverConnect::onRecv;
  v6 = (_DWORD *)(v4 >> 3);
  ...
  if ( std::operator==<common::minet::Packet>((const std::shared_ptr<common::minet::Packet> *)(v4 + 160), 0LL) )
  {
    common::milog::MiLogStream::create(
      ...
      3u,
      "./src/network/tothemoonserver_connect.cpp",
      "onRecv",
      24);
