// File: /data/jenkins/jenkins_hk4e/workspace/hk4e_3.4_dev/gateserver/src/main.cpp

// Line 25: range 000000000C748F46-000000000C749421
int __cdecl main(int argc, const char **argv, const char **envp)
{
  ...
  *(_QWORD *)(v3 + 8) = "1 32 288 13 app_config:29";
  *(_QWORD *)(v3 + 16) = main;
  v5 = (_DWORD *)(v3 >> 3);
  ...
  std::string::assign(v3 + 32, "gateserver");
