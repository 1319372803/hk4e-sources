// File: /data/jenkins/jenkins_hk4e/workspace/hk4e_3.4_dev/muipserver/src/main.cpp

// Line 24: range 000000000CB94AB2-000000000CB94F8D
int __cdecl main(int argc, const char **argv, const char **envp)
{
  ...
  *(_QWORD *)(v3 + 16) = main;
  ...
  std::string::assign(v3 + 32, "muipserver");
  ...
  std::string::append(v3 + 64, "23:00:04");
  *(_DWORD *)(v3 + 224) = 300;
  *(_DWORD *)(v3 + 228) = argc;
  *(_QWORD *)(v3 + 232) = argv;
