// File: /home/jingtian.zhang/serverCode/hk4e/ext_merge/mysql-server-mysql-5.5.30/mysys/charset-def.c

// Line 148: range 000000000CFC7490-000000000CFC7B29
my_bool __fastcall init_compiled_charsets(myf flags)
{
  CHARSET_INFO *i; // rbx
  CHARSET_INFO *v2; // rdi
  ...
  for ( i = compiled_charsets; i->name; ++i )
  {
    v2 = i;
    add_compiled_collation(v2);
  }
  return 0;
};
